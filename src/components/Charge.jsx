export default function Charge({ poles, domains, settings, updateDomainDays, updateSetting }) {
  ...
  return (
    <div className="container">
      ...
      <div className="charge-hero">
        <div>
          <div style={{fontFamily:'Syne, sans-serif', fontSize:56, fontWeight:800, color:'#d4a843', lineHeight:1}}>{total}</div>
        ...
        <div style={{textAlign:'right'}}>
          <div style={{fontFamily:'DM Mono, monospace', fontWeight:700, fontSize:15, color:diffColor}}>
            {dispatched}j — {diffStr}
          </div>
        </div>
      </div>
